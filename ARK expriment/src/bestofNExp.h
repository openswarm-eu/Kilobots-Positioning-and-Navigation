...
private:
    ...
    QString im_filename_prefix="/home/salah/KBArenaExpsData/ANTS2024";
    QString im_filename_suffix="/image_%1.jpg";
    ...
    bool logExp;
    QFile log_file;
//    QString log_filename_prefix="/home/salah/KBArenaExpsData/ANTS2024/run%1";
//    QString log_filename_suffix="/log.txt";
//    QString log_opts_filename_suffix="/log_optionPositionAndQuality.txt";
    ...
    float m_gps_last_time_sent = 0.0;
    float m_gps_sending_freq = 2.0;
